...
#./sample $1 $2
#python Vanilla_EA.py 'problems/a2.lup'
/linux_apps/python-3.6.1/bin/python3 Vanilla_EA.py $1 $2 || python3 Vanilla_EA.py $1 $2
#/linux_apps/python-3.6.1/bin/python3 ./exampleCode/example.py 'problems/a2.lup' || python3 ./assignment_1b/Vanilla_EA.py $1 $2
